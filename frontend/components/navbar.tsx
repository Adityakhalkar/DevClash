...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-center w-full dark:bg-black bg-white">
      <nav className="relative backdrop-filter w-3/4 backdrop-blur-4xl bg-black/80 z-50 rounded-b-xl h-12 shadow-lg">
              ...
              {loading ? (
                ...
                <>
                  ...
                  >
                    <Link 
                      href="/login" 
                      className="sm:px-4 px-1 sm:py-2 py-1 mt-2 rounded-md text-sm font-medium bg-gradient-to-r from-amber-500 to-amber-400 text-gray-900 shadow-lg shadow-amber-500/20"
                    >
                      Get Started
                    </Link>
                  </motion.div>
